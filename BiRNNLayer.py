...
class BiRNNLayer():
    def __init__(self, vocab_size, seq_length, scope, inputs=None, model="lstm", num_layers=1, batch_size=10, 
        ...
        if inputs is None: #this layer is first layer! Get feed_dict data and embed.
            self.inputs = tf.placeholder(tf.int32, [batch_size, seq_length]) #allows for variable seq_length
