...
class AttentionLayer():
    ...
    def __init__(self, p_inputs, q_inputs, hidden_size, scope, batch_size=10, training=True):
        ...
        att_on_q_aug = tf.tile(tf.nn.softmax(sim_mtx, dim=2), [1, 1, 1, 2*hidden_size])
        ...
        weights_p = tf.tile(att_on_p, [1, 1, 2*hidden_size]) #batch_size x p_length x hidden_size
